...
@IBDesignable class SHCircleBar: UITabBar {
    ...
    override func draw(_ rect: CGRect) {
        let fillColor: UIColor = UIColor(named: "greenGreatTint") ?? .white
    ...
    func customInit(){
        self.tintColor = UIColor(named: "mainBackgroundColor") ?? .white
        self.barTintColor = UIColor(named: "mainBackgroundColor") ?? .white
        self.backgroundColor = UIColor(named: "mainBackgroundColor") ?? .white
    }
